...
interface IRentalCustodialEscrow {
    struct Deal {
        address payee;
        address payer;
        address token;
        ...
        bool isPayerFullySettled;
        bool isPayeeCanReleaseFund;
        bool isFundFullyReleasedToPayee;
        bool isActive;
    }

    function initialize(address[] memory _whitelisted, address[] memory _whitelistedTokens, address _operator) external;
